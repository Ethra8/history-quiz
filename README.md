...
### LOOKS GOOD
All of the implemented features in this site, as listed below, look good on all devices, from x-small phones to larger desk tops. Please refer to the [test recordings and results](#test-recordings-and-results) above to watch recordings made from different devices, systems, and browsers.
- **HOME PAGE**
- **404 ERROR PAGE**
- **NAVIGATION BAR**
- **QUIZ QUESTIONS**
