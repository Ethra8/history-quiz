...
#### WCAG 2.1 Validation
All tests have passed at level AAA
- 
- **DARK MODE**  
    * **LUMINOSITY AND CONTRAST RATIO** between ***aquamarine (#7FFFD4)*** and ***Oxford Blue (#001C3B)***, used for the h1 in header, the favicon, the Question number titles, and buttons. The following report has been generated by [Juicy Studio](https://juicystudio.com/services/luminositycontrastratio.php) :

    ![image](https://github.com/Ethra8/history-quiz/assets/80659091/02b06bea-b33e-4fab-b9b7-2d847c7e217e)

    * **LUMINOSITY AND CONTRAST RATIO** betwee ***whitesmoke (#F5F5F5)*** and ***Oxford Blue (#001C3B)***, used for the word "Quiz" in header, for the questions' paragraph and options (radio labels), and for the final results.

    ![image](https://github.com/Ethra8/history-quiz/assets/80659091/89fd349e-9753-49a6-894a-20c7e2822b9e)

- **LIGHT MODE**
    * **LUMINOSITY AND CONTRAST RATIO** between ***
